                ...
                <div style={{ marginTop: "2rem" }}>
                    ...
                    >
                        ...
                        <p>
                            ...
                            {debug?.agent_type || "unknown"}
                        </p>

                        <p>
                            <strong>Language model:</strong>{" "}
                            {debug?.language_model || selectedModel || "unknown"}
                        </p>

                        <p>
                            <strong>Qwen Reranker:</strong>{" "}
                            {debug?.use_reranker ? "enabled" : "disabled"}
                        </p>
                    ...
                    {chunks.length > 0 ? (
                        chunks.map((chunk, index) => (
                            ...
                            >
                                <summary>
                                    #{index + 1} | {chunk.source_file} | chunk:{" "}
                                    {chunk.chunk_id} | score: {chunk.score}
                                </summary>

                                <p>
                                    <strong>Agent:</strong> {chunk.agent || "n/a"}
                                </p>
